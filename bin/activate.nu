...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/jonahetuaful/Development/Python/job-suite'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/jonahetuaful/Development/Python/job-suite/bin/deactivate.nu'
